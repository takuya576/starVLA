...
if [ -z "$MODEL_PATH" ]; then
  ...
  export MODEL_PATH="/home/takuya/llavavla/results/Checkpoints/1_need/QwenGR00T/checkpoints/steps_30000_pytorch_model.pt"
fi
...
EvalSim() {
  ...
  CUDA_VISIBLE_DEVICES=${gpu_id} ${sim_python} examples/simBenchmarks/SimplerEnv/eval_files/start_simpler_env.py --ckpt-path ${ckpt_path} \
...
while pgrep -f "examples/simBenchmarks/SimplerEnv/eval_files/start_simpler_env.py" > /dev/null; do
